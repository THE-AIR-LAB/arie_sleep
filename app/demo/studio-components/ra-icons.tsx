...
export const Ic = {
  ...
  /* Corners pulling in — restore / shrink to normal frame. */
  Minimize: mk(<><path d="M9 4v5H4" /><path d="M15 4v5h5" /><path d="M9 20v-5H4" /><path d="M15 20v-5h5" /></>),
  ...
  /* Outline thumbs — match Lucide stroke style used elsewhere. */
  ThumbUp: mk(
    <>
      <path d="M7 10v12" />
